...
const config = {
  title: 'AI RAG Chatbot Documentation',
  tagline: 'Documentation for the RAG Chatbot project',
  ...
  baseUrl: '/backend/', // Replace 'backend' with your repository name
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/your-username/your-repo/edit/main/docs/',
        },
        blog: {
